...
export const LOCATIONS_SETTING_KEY = "locations";
export const LOOT_POOLS_SETTING_KEY = "lootPools";
export const RANDOM_LOOT_PACK_SETTING_KEY = "randomLootPack";
export const RULES_SETTING_KEY = "rulesConfig";
export const LANGUAGE_MODE_SETTING_KEY = "languageMode";
...
export const PLAYER_REQUEST_FLAG = "playerRequest";
export const SELECTED_PACK_ALIAS = "@selected";
