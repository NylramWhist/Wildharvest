  ...
  return `
    <div class="wildharvest-gm-history-detail">
      ...
      <dl class="wildharvest-gm-history-detail__stats">
        ...
        <div><dt>${escapeHtml(t("WILDHARVEST.Dialog.Search.BaseModifier"))}</dt><dd>${escapeHtml(formatSignedModifier(baseSkillModifier))}</dd></div>
        <div><dt>${escapeHtml(t("WILDHARVEST.Dialog.Search.ExtraModifier"))}</dt><dd>${escapeHtml(formatSignedModifier(extraModifier))}</dd></div>
        <div><dt>${escapeHtml(t("WILDHARVEST.Dialog.Search.FinalModifier"))}</dt><dd>${escapeHtml(formatSignedModifier(finalSkillModifier))}</dd></div>
